...
jarsigner -keystore "$FULLY_QUALIFIED__SELF_PATH/foo.keystore" -storepass "111111" -keypass "111111" -digestalg "SHA1" -sigalg "SHA1withRSA" "$FULLY_QUALIFIED__PATH_BASE_EXT" "alias_name"
